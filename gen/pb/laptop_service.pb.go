...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70,
	...
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68, 0x6f, 0x6f,
	0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52,
	...
	0x12, 0x25, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x62,
	0x6f, 0x6f, 0x6b, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x74, 0x65, 0x63, 0x68, 0x73, 0x68,
	...
	0x00, 0x42, 0x29, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x2e,
...
var file_laptop_service_proto_goTypes = []interface{}{
	(*CreateLaptopRequest)(nil),  // 0: techshool.pcbook.CreateLaptopRequest
	(*CreateLaptopResponse)(nil), // 1: techshool.pcbook.CreateLaptopResponse
	(*Laptop)(nil),               // 2: techshool.pcbook.Laptop
}
var file_laptop_service_proto_depIdxs = []int32{
	2, // 0: techshool.pcbook.CreateLaptopRequest.laptop:type_name -> techshool.pcbook.Laptop
	0, // 1: techshool.pcbook.LaptopService.CreateLaptop:input_type -> techshool.pcbook.CreateLaptopRequest
	1, // 2: techshool.pcbook.LaptopService.CreateLaptop:output_type -> techshool.pcbook.CreateLaptopResponse
...
func (c *laptopServiceClient) CreateLaptop(ctx context.Context, in *CreateLaptopRequest, opts ...grpc.CallOption) (*CreateLaptopResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/techshool.pcbook.LaptopService/CreateLaptop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LaptopService_CreateLaptop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/techshool.pcbook.LaptopService/CreateLaptop",
	}
...
var _LaptopService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "techshool.pcbook.LaptopService",
